...
function Column({board, column, updateColumnTitle, createNewCard, deleteColumnDetails, }) {
  ...
  const handleTitleBlur = () => {
    if (editedTitle !== column.title) {
      updateColumnTitle(column._id, editedTitle) 
    }
    setIsEditing(false)
  }
  ...
  // Handling deleting a column and the cards inside it
        ...
        <Box sx={{
          ...
          <Box>
            ...
            >
              ...
              >
                <ListItemIcon><DeleteForeverIcon className="delete-forever-icon" Cloud fontSize="small" /></ListItemIcon>
